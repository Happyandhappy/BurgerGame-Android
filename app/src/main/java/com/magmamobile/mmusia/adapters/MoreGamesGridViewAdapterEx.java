...
public class MoreGamesGridViewAdapterEx extends BaseAdapter
{
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        if(view == null)
        {
            view = (new ItemGridViewMoreGame(mContext)).getRootView();
        ...
        if(MMUtils.isPackageNameInDevice(mContext, itemmoregames.pname))
        {
            viewholder.txtTitle.setTextColor(0xff888888);
        } else
        {
            viewholder.txtTitle.setTextColor(0xff888888);
        }
